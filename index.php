...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      <a class="navbar-brand" href="#"><img id="brnd_new" alt="Brand" style="position: relative; max-width:100px; left: 15px; max-height: 60px; margin-top:-19px ; background-size: contain;" src="logo/aunkur_logo (1).png" /></a>
    </div>
