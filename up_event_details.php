 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_up_event_details.php" method="get">
...
$conn=mysqli_connect("localhost","root","","literatute_club"); 
				...
				$eql="SELECT * FROM up_events where id=$nid";
              $result = $conn->query($eql);
		  while($row = $result->fetch_assoc()) 
		  {
			
		     echo'<form id="" action="up_event_update.php" method="post" enctype="multipart/form-data">';
	         ...
	         echo' <label for="">Event Name:</label>
				  ...
				  <div class="form-group">
				    ...
				    <textarea class="form-control" rows="6" name="edesc" id="edesc"  value="'.$row['edesc'].'" required>'.$row['edesc'].' </textarea>
...
var d = document.getElementById("edesc").value;
