 ...
 ?>
  ...
  <script type="text/javascript">
    $('#update').click(function(){ 
     ...
     var h = document.getElementById("ABOUT_HEADER").value;
  var d = document.getElementById("DESCRIPTION").value;
  if(h && d) {
	  alert('Your details have been updated');
	  var string_url = "http://localhost/WEB/about_update.php?" +"ABOUT_HEADER="+ h + "&DESCRIPTION=" + d;
	  window.location = string_url;
}
else
{
	alert('Your details have  not been updated');
}
