 ...
 <!-- ************* Navbar Start *************-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form action="Content_update/content_update_prev_event_details.php" method="get">
...
$conn=mysqli_connect("localhost","root","","literatute_club"); 
				...
				$eql="SELECT * FROM prev_events where id=$nid";
              $result = $conn->query($eql);
		  while($row = $result->fetch_assoc()) 
		  {
			
		     echo'<form id="" action="prev_event_update.php" method="post" enctype="multipart/form-data">';
